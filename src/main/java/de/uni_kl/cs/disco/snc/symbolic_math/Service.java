...
public class Service implements Serializable {
	 ...
	 * service being dependent on itself.
	 * 
	 * @param sigma the time independent part of the MGF-bound
	 * @param rho the time dependent part of the MGF-bound
	 ...
	 * 
     * @throws de.uni_kl.cs.disco.snc.symbolic_math.ThetaOutOfBoundException
	 * @throws ServerOverloadException 
     * @throws de.uni_kl.cs.disco.snc.symbolic_math.ParameterMismatchException 
	 */
